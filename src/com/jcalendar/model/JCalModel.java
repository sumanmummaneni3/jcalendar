 ...
 * JCalModel.java has been created on Jul 7, 2013
 * 
 *********************************************************************/
...
public class JCalModel extends AbstractTableModel implements Serializable {
	...
	/** The month list. */
	private String[] monthList = { "Jan", "Feb", "Mar", "Apr", "May", "Jun",
	...
	private void initModel() {
		...
		yearModel = new SpinnerNumberModel(currentYear, model
				.getMinimum(Calendar.YEAR), model.getMaximum(Calendar.YEAR), 1);
		String space = " ";
	...
	public int getSeconds(){
		return model.get(Calendar.SECOND);
	}
